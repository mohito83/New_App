...
public class VideoPlayer2Activity extends Activity implements VideoControllerView.MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this is to show the up button on action bar to go back to home screen
     	...
     	TextView titleView = (TextView)findViewById(R.id.videoPlayerTitle2);
		TextView descView = (TextView)findViewById(R.id.videoPlayerDesc2);
