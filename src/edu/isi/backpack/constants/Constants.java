...
public class Constants {
    ...
    public static final String WIFI_SERVICE_HEADER = "Balatarin_";
    ...
    public static final String metaFileName = "metadata.db";
    ...
    /**************************************************/
    public static final short META_DATA_FULL = 1;

    public static final short META_DATA_TMP = 3;
    ...
    /**
     * This constant defined the timeout period for which your bluetooth device
     * will be visible to other devices.
     */
