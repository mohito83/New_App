 ...
 * @author jenniferchen
 * 
 * This task takes the given URI of an image and displays the bitmap on the given image view
 *
 */
public class BitmapTask extends AsyncTask<Uri, Integer, Bitmap>{
	 ...
	 */
	public BitmapTask(ImageView imageView, ContentResolver cr, int w, int h, LruCache<String, Bitmap>cache){
	 ...
	 * @return
	 */
	public static BitmapTask BitmapTaskByHeight(ImageView imageView, ContentResolver cr, int h, LruCache<String, Bitmap>cache){
