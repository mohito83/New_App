...
/**
 * @author jenniferchen A page to show comments for an individual content
 */
public class CommentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ListIterator<Comment> iter = comments.listIterator(comments.size()); // bi-directional
                                                                             // iterator
        while (iter.hasPrevious()) { // want to show comments in reverse order
            Comment comment = iter.previous();
            commentsView.append(Html.fromHtml("<b>" + comment.getUser() + "</b> ("
                    + comment.getDate() + ")<br />"));
        ...
        addButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (!text.isEmpty()) {
                    ...
                    commentsView.setText(Html.fromHtml("<p><b>" + user + "</b> (" + date
                            + ")<br />" + text));
                    ...
                    LocalBroadcastManager.getInstance(CommentsFragment.this.getActivity())
                            .sendBroadcast(i);
                }
            }
